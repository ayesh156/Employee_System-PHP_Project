									...
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="form-group">
												...
												<input name="project_name" id="upname2" type="text" class="form-control" disabled autocomplete="off" placeholder="Enter Project Name" value="<?php echo $project_details_data["name"]; ?>" />
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="form-group">
												...
												<?php
												$project_type_rs = Database::search("SELECT * FROM `project_type` WHERE `id` = '" . $project_details_data["project_type_id"] . "' ");

												$project_type_data =  $project_type_rs->fetch_assoc();

												?>

												<input name="project_type" id="uptype" disabled type="text" class="form-control" autocomplete="off" placeholder="Enter Project Start Date" value="<?php echo $project_type_data["name"]; ?>" />
									...
									<div class="row">
										<div class="col-md-6 col-sm-12">
											<div class="form-group">
												...
												?>
												<input name="start_date" id="upstart" disabled type="text" class="form-control" autocomplete="off" placeholder="Enter Project Start Date" value="<?php echo $start_date; ?>" />
											</div>
										</div>
										<div class="col-md-6 col-sm-12">
											<div class="form-group">
												...
												?>
												<input name="end_date" id="upend" disabled type="text" class="form-control" autocomplete="off" placeholder="Enter Project End Date" value="<?php echo $end_date; ?>" />
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-12">
											<div class="form-group">
												...
												<textarea name="requirements" id="upreq" disabled class="form-control" placeholder="Describe project requirements in detail.." autocomplete="off"><?php echo $project_details_data["description"]; ?></textarea>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<a href="process/download.php?file=<?php echo $project_details_data["res_path"]; ?>" class="btn btn-primary"><i class="fa fa-download"></i> Download Project</a>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="modal-footer justify-content-center">
													<button class="btn btn-primary" data-toggle="modal" data-target="#uploadModal" href="uploadModal"><i class="fa fa-cloud-upload"></i> Upload</button>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="wizard-content">
								...
								<div class="row">
									...
									?>
										...
										<div class="col-md-12 col-sm-12">
											<div class="form-group text-center">
												<h6 class="h6">Project has no uploaded yet.</h6>
											</div>
										</div>
					...
					<div class="modal-content">
						<div class="weight-500 col-md-12 pd-20">
							<div class="form-group">
								<div class="row">
									<div class="col-12">
										<h4 class="h4">Upload Completed Project</h4>
									</div>
									<div class="col-12">
										<label for="pcomment">Describe project :</label>
										<textarea id="pcomment" name="description" class="form-control" placeholder="Give a description about the project..." autocomplete="off"></textarea>
									</div>
									<div class="col-12 mt-15">
										<div class="form-group">
											<label>(Upload all resources as a zip file)</label> <br />
											<input type="file" class="d-none" id="proFile" accept="application/zip,application/x-zip,application/x-zip-compressed,application/octet-stream" />
											<label for="proFile" style="display: inline;" class="btn btn-primary" onclick="uploadProjectFiles()"><i class="fa fa-cloud-upload"></i> Re-upload Resources</label>
											<h6 style="display: inline;" id="proFileName"></h6>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary" onclick="uploadComProject(<?php echo $id; ?>);">Submit</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						</div>
					</div>
				</div>
			</div>
			<!-- Project Upload Modal End -->
