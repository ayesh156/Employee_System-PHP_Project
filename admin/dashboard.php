...
?>
	...
	<body>
		...
		$project_details_rs = Database::search("SELECT * FROM `project`");
			...
			<div class="pd-ltr-20">
				...
				<div class="card-box pd-20 height-100-p mb-30">
					<div class="row align-items-center">
						...
						<?php
						$user_rs = Database::search("SELECT * FROM `admin_details` WHERE `admin_email` = '".$email."' ");
				...
				<div class="row pb-10">
					...
					$staff_rs = Database::search("SELECT * FROM `staff`");
					$staff_num = $staff_rs->num_rows;

					?>

					<!-- Staff and Project Details Card Section -->
						...
						<div class="card-box height-100-p widget-style3">
							...
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark"><?php echo $staff_num; ?></div>
					...
					$c_project_rs = Database::search("SELECT * FROM `project` WHERE `status_id` = '2'");
					...
					$p_project_rs = Database::search("SELECT * FROM `project` WHERE `status_id` = '1' ");
					...
					$r_project_rs = Database::search("SELECT * FROM `project` WHERE `status_id` = '3' ");
				...
				<!-- Staff and Project Details Card Section End -->
				...
				<!-- Company Heads List -->
					...
					<div class="col-lg-4 col-md-6 mb-20">
						<div class="card-box height-100-p pd-20 min-height-200px">
							<div class="d-flex justify-content-between">
								<div class="h5 mb-0">Employees</div>
								<div class="table-actions">
									<a title="VIEW" href="staff.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>
								</div>
							</div>
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
								...
								$project_rs = Database::search("SELECT project.id AS pid, staff_details.staff_email, staff_details.first_name, staff_details.last_name, project.name AS pname, project_type.name AS ptname, project.start_date, project.end_date FROM `project` INNER JOIN `staff_details` ON project.staff_email = staff_details.staff_email INNER JOIN project_type ON project.project_type_id = project_type.id WHERE `status_id` = '1' ");
