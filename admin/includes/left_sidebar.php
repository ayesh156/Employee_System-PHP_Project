		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="project_type.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Project Type</span>
						</a>
					</li>
					<li class="dropdown">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext">Project</span>
						</a>
						<ul class="submenu">
							<li><a href="add_project.php">Add Project</a></li>
							<li><a href="projects.php">Projects History</a></li>
						</ul>
					</li>
