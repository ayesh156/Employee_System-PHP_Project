...
if (isset($_SESSION["a"])) {
	...
	if (isset($_GET["id"]) && !empty($_GET["id"])) {
		...
		$s_project_type_rs = Database::search("SELECT * FROM `project_type` WHERE `id` = '" . $id . "' ");
		$s_project_type_num = $s_project_type_rs -> num_rows;

		if($s_project_type_num > 0) {

		$s_project_type_data = $s_project_type_rs->fetch_assoc();
...
?>
				...
				<div class="pd-ltr-20 xs-pd-20-10">
					...
					<!-- Breadcrumb Section -->
						...
						<div class="row">
							...
							<!-- Update Project Type Section -->

							<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
								<div class="card-box pd-30 pt-10 height-100-p">
									<h2 class="mb-30 h4">Edit Project Type</h2>
									<section>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="ptuname">Project Type</label>
													<input name="ptname" id="ptuname" type="text" class="form-control" autocomplete="off" value="<?php echo $s_project_type_data["name"]; ?>" />
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="ptudec">Project Type Description</label>
													<textarea name="description" id="ptudec" type="text" style="height: 5em;" class="form-control text_area"><?php echo $s_project_type_data["description"]; ?></textarea>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-12 text-right">
											<div class="dropdown">
												<button class="btn btn-primary" onclick="updateProjectType(<?php echo $id; ?>);">UPDATE</button>
											</div>
										</div>
									</section>
								</div>
							...
							<!-- Update Project Type Section End -->
		...
		?>
			...
			<h3>Please select project type first!</h3>
